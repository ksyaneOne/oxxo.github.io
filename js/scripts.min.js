...
$(document).ready(function(){$(".o-header-carousel-item").animated("fadeInDown","fadeInUp"),$(".o-about-title").animated("fadeInDown","fadeInUp"),$(".o-about-description").animated("fadeInUp","fadeInDown"),$(".o-about-content").animated("fadeInRight","fadeInLeft"),$(".hr-light").animated("fadeIn","fadeOut"),$(".o-about-slider").animated("fadeInLeft","fadeInRight"),$(".o-amazing-title").animated("fadeInDown","fadeInUp"),$(".o-amazing-descr").animated("fadeInUp","fadeInDown"),$(".o-amazing-box").animated("fadeIn","fadeOut"),$(".o-team-title").animated("fadeInDown","fadeInUp"),$(".o-team-description").animated("fadeInUp","fadeInDown"),$("figure").animated("fadeIn","fadeOut"),$(".o-works-title").animated("fadeInDown","fadeInUp"),$(".o-works-description").animated("fadeInUp","fadeInDown"),$(".hr-dark").animated("fadeIn","fadeOut"),$("figure").animated("fadeIn","fadeOut"),$(".o-buy-title").animated("fadeInDown","fadeInUp"),$(".o-buy-description").animated("fadeInUp","fadeInDown"),$(".a-left").animated("fadeInLeft","fadeInRight"),$(".a-right").animated("fadeInRight","fadeInLeft"),$(".o-clients-title h2").animated("fadeInDown","fadeInUp"),$(".o-responsive-title").animated("fadeInDown","fadeInUp"),$(".o-responsive-description").animated("fadeInUp","fadeInDown"),$(".o-responsive-image").animated("fadeInLeft","fadeInRight"),$(".o-responsive-content li").animated("fadeInRight","fadeInLeft"),$(".o-header-carousel").owlCarousel({loop:!0,nav:!0,navText:['<img src="img/header-left-nav.png"></img>','<img src="img/header-right-nav.png"></img>'],smartSpeed:900,responsiveClass:!0,startPosition:1,autoplayHoverPause:!0,responsive:{0:{items:1}}}),$(".o-about-carousel").owlCarousel({loop:!0,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],smartSpeed:700,autoplay:!0,responsiveClass:!0,startPosition:1,autoplayHoverPause:!0,responsive:{0:{items:1}}}),$(".o-clients-carousel").owlCarousel({loop:!0,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],smartSpeed:700,autoplay:!0,responsiveClass:!0,startPosition:1,autoplayHoverPause:!0,responsive:{0:{items:1}}}),$(".o-clients-company-carousel").owlCarousel({loop:!0,smartSpeed:700,autoplay:!0,responsiveClass:!0,autoplayHoverPause:!0,responsive:{0:{items:3},479:{items:4}}}),$(".hamburger1, .hidden-nav a").click(function(){$(".hamburger1").toggleClass("toggle1"),$(".hidden-nav").toggleClass("hidd")}),$(".nav-right a, .nav-left a, .hidden-nav a, .top").mPageScroll2id(),$(".preloader").fadeOut(),$.fn.responsiveTabs=function(){return this.each(function(){var e=$(this),a=e.find("dt"),n=(e.find("dd"),$('<div class="responsive-tabs-placeholder"></div>').insertAfter(e));a.on("click",function(){var e=$(this);a.not(e).removeClass("active"),e.addClass("active"),n.html(e.next().html())}),a.filter(":first").trigger("click")})},$(".responsive-tabs").responsiveTabs()}),$(window).scroll(function(){$(document).scrollTop()>150?$(".top").addClass("show").show():$(".top").removeClass("show").hide()});